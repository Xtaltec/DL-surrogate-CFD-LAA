...
%% Number of the simulation to be conducted
i=1;
...
try
    ...
    disp(['Simulation number: ',num2str(i),' has failed at calculation'])
end

disp('The simulation has been completed! YAY!')
