...
EncasDir='D:\\Simulations\\EncaseFiles\\LAA_8\\LAA_8.encas'
...
# save data
SaveData('D:\Simulations\EncaseFiles\LAA_8\ECAP\LAA.csv', proxy=lAA_1encas, WriteTimeSteps=1)
...
# save data
SaveData('D:\Simulations\EncaseFiles\LAA_8\ECAP\LAA.stl', proxy=extractSurface1, FileType='Ascii')

# hide data in view
Hide(extractSurface1, renderView1)

# create a new 'STL Reader'
EncasDir='D:\\Simulations\\EncaseFiles\\LAA_8\\ECAP\\LAA1.stl'
...
# save data
SaveData('D:\Simulations\EncaseFiles\LAA_8\ECAP\LAA_SURFACE.vtk', proxy=lAA1stl, FileType='Ascii')
